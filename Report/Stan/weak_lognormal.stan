...
model {
  // Priors
  alpha ~ normal(30.92273907, 1.51599403);
  beta ~ normal(0.54209422,0.13782044);
  ...
  sigma_species ~ lognormal(-0.4819767 , 0.5522755 );
  sigma_sex ~ lognormal(-0.6415951  , 1.382282);
  sigma_obs ~ cauchy(2.25119465, 1.05029 );
